...
The **[AortaSeg24 Challenge](https://aortaseg24.grand-challenge.org/)** has concluded, and the dataset is now openly available to anyone upon completing the Data Use Agreement (DUA) form. To access the dataset, please fill out the **[Data Use Agreement (DUA)](https://na3.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=1e71cea6-b652-4f89-b1e4-5f72f7cbd3d4&env=na3&acct=38f380cc-7bc9-468e-9c99-fc5ba7151d54&v=2)** form. Upon submission and approval, you will gain full access to the dataset.
